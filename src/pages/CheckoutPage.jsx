...
function CheckoutPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow border border-gray-200 mt-8 p-6">
      {/* Başlık */}
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="flex items-center mb-2">
            ...
            <span className="text-orange-600 font-semibold">Kart ile Öde</span>
          </div>
          <div className="text-gray-700 mb-4">
            Kart ile ödemeyi seçtiniz. <b>Banka veya Kredi Kartı</b> kullanarak
          ...
          <form>
            ...
            <div className="flex items-center mb-2">
              ...
              >
                <span className="text-gray-900">3D Secure</span> ile ödemek
                istiyorum
              </label>
            </div>
          </form>
        ...
        <div className="flex-1 border-l border-gray-200 pl-8">
          <div className="font-semibold text-lg mb-2">Taksit Seçenekleri</div>
          <div className="text-gray-700 mb-4">
            Kartınıza uygun taksit seçeneğini seçiniz
          </div>
          <div className="border rounded-lg overflow-hidden">
            <div className="flex bg-gray-50 font-semibold text-gray-700">
              <div className="flex-1 px-4 py-2 border-r">Taksit Sayısı</div>
